...
namespace QuanLyKeyAuto
{
    public partial class UpdateForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            bool resultAdd = m_objInformationBLL.ThemMoiKey(txtTenGoiNho.Text, txtSerialNumber.Text, txtKey.Text, cbbLoaiTool.Text, dateTimePickerHSD.Value);
            if (resultAdd)
            {
